////////////////////////////////////////////////////////////////////////
//
//            GameLibZero 2.0.1 by Luis Lopez Martinez
//                11/09/2017 - Barcelona SPAIN.
//                        OPEN SOURCE  
...
class sprite {
  ...
  void draw(){
    ...
    //..............................
    void setVx(float vx) {
        b.adjustVelocity(vx, 0);
    }
    //..............................
    //..............................
    void setVy(float vy) {
        b.adjustVelocity(0, vy);
    }
    //..............................
  ...
  boolean collision(sprite id_){
      if(getDist(id_.x, id_.y) < (id_.radius + radius)){
          return true;
      }
      return false;
  }
...
boolean collisionMouse(sprite id){
  float w = (id.graph.width * id.sizeX) / 100.0;
  float h = (id.graph.height * id.sizeY) / 100.0;
  //println(w, h);
  if( (mouse.x > (id.x - w/2)) && (mouse.x < (id.x + w/2)) ){
    if( (mouse.y > (id.y - h/2)) && (mouse.y < (id.y + h/2)) ){
      return true;
    }
  }
  return false;
